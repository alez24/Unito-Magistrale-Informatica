...
\hline
\textbf{Tipologia} & \textbf{Input Italiano (SVO)} & \textbf{Output Yodish (XSV)} & \textbf{Analisi} \\ \hline
...
\subsection{Limiti del Sistema (Test Negativi)}
