...
Un $q^*$-block (classe di equivalenza) \`{e} $l$-diverso se ha almeno $l \geq 2$ diversi valori sensibili ben rappresentati (il valore $l$ pi\`{u} frequente ha all'incirca la stessa frequenza degli altri).
...
\textbf{Curse of Dimensionality} (Aggarwal, VLDB 2005): quando il numero di quasi-identificatori cresce, la k-anonymity diventa inutile perch\'{e} richiede una generalizzazione eccessiva.
